...
Download the pre-trained SAM (Segment Anything Model) checkpoints and save them in the `/pretrained_checkpoints/` directory:

- **`vit_b`**: [ViT-B SAM Model](https://dl.fbaipublicfiles.com/segment_anything/sam_vit_b_01ec64.pth)  
  *(Default configuration. No additional changes needed.)*

You can also use the following checkpoints, but you'll need to update the `attnfnet_config.py` file accordingly:

- **`vit_h`**: [ViT-H SAM Model](https://dl.fbaipublicfiles.com/segment_anything/sam_vit_h_4b8939.pth)
- **`vit_l`**: [ViT-L SAM Model](https://dl.fbaipublicfiles.com/segment_anything/sam_vit_l_0b3195.pth)

> 📌 These checkpoints are provided by the [Segment Anything project](https://github.com/facebookresearch/segment-anything) by Meta AI.
--- 
